...
**System** - First-run setup (name, city, accent), 9 accent themes (Demon Slayer palette), light/dark theme toggle, sidebar with custom avatar, mobile responsive, fully offline (except optional weather and CDN-loaded fonts/icons).
...
```
index.html              ← Entry point (~860 lines)
