...
| `goals.js` | `showConfirm`, `showAlert`, `updateGreeting`, `renderStatsPanel`, `renderCalendar`, `renderHomeInsights` | `goals:YYYY-MM-DD`, `clock_format_v1`, `quick_notes_v1`, `tweak_*` |
| `finances.js` | `renderGoals` (financial savings goals), `renderFinances`, `toggleGroup`, `deleteIncome`, `deleteExpense` | `finances_data_v1` |
| `habits.js` | `renderHabits`, `renderHabitFullRings`, `renderHomeHealthRings`, `renderHomeMood` | `habits:*`, `mood:*` |
